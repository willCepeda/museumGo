...
if(!empty($_POST)){
	if($_POST['boton']=="Actualizar Datos"){
		...
		$sql.=" nombre = '".$_POST['first_name']." ".$_POST['second_name']."', apellidos = '".$_POST['first_lastname']." ".$_POST['second_lastname']."' WHERE profesor.usuario = '".$_SESSION['user']."';";
		...
		$result = $conexion->query($sql);
		$meta="<meta http-equiv='refresh' content='1;URL=index_user.php?visit=1'>";
							...
							<li>
								...
								<ul>
									<li>
										<a href="#">Perfil</a>
										<ul>
										<li><a href='modify_teacher.php'>Modificar</a></li>
										</ul>
									</li>
									<li>
									<a href="#">Visitas</a>
