...
$msg_teacher="";	
	 ...
	 if(!empty($_GET)){
		 if(!empty($_GET['id'])){
		$id_user = $_GET['id'];
		$sql = "DELETE FROM actividad_profesor  WHERE  id_actividad='".$id_user."';";
		$result = $conexion->query($sql);
		
		$msg_teacher = "Se ha eliminado una actividad correctamente.";		
			...
			<!-- Main -->
				<section id="main" class="container">
					<header>
						...
						<p>Lista de Actividad Publicadas/No Publicadas.</p>
					</header>
					<div class="row">
						<div class="col-12">
									...
									<div >
										<table >
											...
											<?php
												...
												$query = "SELECT * FROM actividad_profesor where codigo_profesor='".$_SESSION['id']."'";
												...
												while($row = $result->fetch_assoc()){
													...
													echo "<a href='delete_act.php?id=".$row["id_actividad"]."' >";
