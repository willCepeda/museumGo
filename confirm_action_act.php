...
if(!empty($_POST)){
	if($_POST['boton']=="Actualizar Datos"){
		...
		$sql.= "UPDATE actividad_profesor SET ";
		
		if(!empty($_POST['name_act_new'])){
			$sql.=" nombre_visita='".$_POST['name_act_new']."',";
			
			
		}
		
		
		$sql.="pregunta='".$_POST['pregunta']."', respuesta='".$_POST['respuesta']."', publicado='".$_POST['publicado']."' where id_actividad='".$_POST['id']."'";
