			...
			<!-- Main -->
				<section id="main" class="container">
					<header>
						...
						<p>Lista de Visitas Publicadas.</p>
					</header>
					<div class="row">
						<div class="col-12">
									...
									<div >
										<table >
											...
											<?php
												...
												$result = $conexion->query("SELECT * FROM visitas_profesor where codigo_profe='".$_SESSION['id']."' and publicado=1");
												...
												while($row = $result->fetch_assoc()){
													...
													echo"<tfoot>
												<tr>
													<td colspan='3'>No hay vistas publicadas</td>
