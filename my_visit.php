									...
									<div >
										<table >
											...
											<?php
												...
												$query="SELECT r.id,r.id_visita,v.nombre_visita,v.comentarios FROM realizar r, visitas_profesor v where r.id_visita = v.id_visita and r.id_estudiante ='".$_SESSION['id']."'";
												...
												while($row = $result->fetch_assoc()){
													...
													echo "<a href='my_visit_student.php?id=".$row["id_visita"]."' >";
													echo "<input type=image  src='images/eyes.png'  width='25' height='25'>";
													echo "</a>";
													echo"</td>";
													echo "<td align='center'>";
													
													echo "<a href='delete_visit_student.php?id=".$row["id"]."' >";
