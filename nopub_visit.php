			...
			<!-- Main -->
				<section id="main" class="container">
					<header>
						...
						<p>Lista de Visitas NO Publicadas.</p>
					</header>
					<div class="row">
						<div class="col-12">
									...
									<div >
										<table >
											...
											<?php
												...
												$result = $conexion->query("SELECT * FROM visitas_profesor where codigo_profe='".$_SESSION['id']."' and publicado=0");
												...
												while($row = $result->fetch_assoc()){
													...
													echo "<a href='view_visit.php?id=".$row["id_visita"]."' >";
													...
													echo "<a href='modify_visit.php?id=".$row["id_visita"]."' >";
													...
													echo"<tfoot>
												<tr>
													<td colspan='3'>No existen visitas No Publicadas</td>
