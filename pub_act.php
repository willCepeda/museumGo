									...
									<div >
										<table >
											...
											<?php
												...
												$result = $conexion->query("SELECT * FROM actividad_profesor where codigo_profesor='".$_SESSION['id']."' and publicado=1");
												...
												while($row = $result->fetch_assoc()){
													...
													echo"<tfoot>
												<tr>
													<td colspan='3'>No hay Actividad publicadas</td>
