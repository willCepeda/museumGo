...
$msg_teacher="";	
	 ...
	 if(!empty($_GET)){
		 if(!empty($_GET['id'])){
		$id_user = $_GET['id'];
		$sql = "DELETE FROM profesor  WHERE profesor.id = '".$id_user."';";
		$result = $conexion->query($sql);
		
		$msg_teacher = "Se ha eliminado a un profesor correctamente.";		
										...
										<table >
											...
											<?php
												...
												while($row = $result->fetch_assoc()){
													...
													echo "<a href='delete_teacher.php?id=".$row['id']."' ><input type='button' value ='Sí' name='boton' /></a>";
