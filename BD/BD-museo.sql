...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-05-2019 a las 16:08:06
...
CREATE TABLE `actividad_profesor` (
  ...
  `codigo_profesor` int(100) NOT NULL
...
(6, 'juanteach@gmail.com', 'teacher01', 'Juan Manuel', 'Arenas Coronado', 1),
...
--
ALTER TABLE `obras`
  ADD KEY `id_obra` (`id_obra`) USING BTREE,
...
ALTER TABLE `pintores`
  ADD PRIMARY KEY (`codigo_pintor`),
  ADD KEY `id_pintor` (`id_pintor`) USING BTREE;
...
ALTER TABLE `visitas_profesor`
  ...
  ADD KEY `codigo_profe` (`codigo_profe`),
  ADD KEY `codigo_museo` (`codigo_museo`);
...
--
ALTER TABLE `visitas_profesor`
  MODIFY `id_visita` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `actividad_profesor`
  ADD CONSTRAINT `actividad_profesor_ibfk_1` FOREIGN KEY (`codigo_profesor`) REFERENCES `profesor` (`id`);

--
-- Filtros para la tabla `hacer_actividad`
--
ALTER TABLE `hacer_actividad`
  ADD CONSTRAINT `hacer_actividad_ibfk_1` FOREIGN KEY (`id_estudiantes`) REFERENCES `estudiantes` (`id`),
  ADD CONSTRAINT `hacer_actividad_ibfk_2` FOREIGN KEY (`id_profesor`) REFERENCES `profesor` (`id`);

--
-- Filtros para la tabla `realizar`
--
ALTER TABLE `realizar`
  ADD CONSTRAINT `realizar_ibfk_1` FOREIGN KEY (`id_estudiante`) REFERENCES `estudiantes` (`id`),
  ADD CONSTRAINT `realizar_ibfk_2` FOREIGN KEY (`id_profesor`) REFERENCES `profesor` (`id`);

--
-- Filtros para la tabla `visitas_profesor`
--
ALTER TABLE `visitas_profesor`
  ADD CONSTRAINT `visitas_profesor_ibfk_1` FOREIGN KEY (`codigo_profe`) REFERENCES `profesor` (`id`),
  ADD CONSTRAINT `visitas_profesor_ibfk_2` FOREIGN KEY (`codigo_museo`) REFERENCES `museos` (`codigo`);
COMMIT;
