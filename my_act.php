									...
									<div >
										<table >
											...
											<?php
												...
												$query ="SELECT h.id,h.realizado ,a.id_actividad, a.pregunta,a.imagenes,a.tipo,a.nom_acti FROM hacer_actividad h, actividad_profesor a where h.id_actividad = a.id_actividad and h.id_estudiantes ='".$_SESSION['id']."'";
												...
												while($row = $result->fetch_assoc()){
													...
													if($row["realizado"] =='0'){
													echo "<a href='re_act_student.php?id=".$row["id_actividad"]."&h=".$row["id"]."' >";
													echo "<input type=image  src='images/y.png'  width='25' height='25'>";
													echo "</a>";
													}else{
														echo "<input type=image  src='images/y.png'  width='25' height='25'>";
													}
													...
													echo"<tfoot>
												<tr>
													<td colspan='3'>No te has apuntado a ninguna visita </td>
