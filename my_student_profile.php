...
if(!empty($_SESSION['user'])){
	...
	$sql="SELECT * FROM estudiantes where usuario='".$_SESSION['user']."' or contrasenia='".$_SESSION['pass']."'";
						...
						<div class="col-12">
							...
							<!-- Text -->
								<section class="box">
									...
									<header>
										<h3>Opciones</h3>
										<p>El estudiante tiene estas funcionalidades que le seran de utilidad para el correcto manejo de la aplicación:</p>
										<ul>
										<li>Listar visitas disponibles</li>
										<li>Inscribirse a una visita</li>
										<li>Listar las visitas a las que se ha suscrito</li>
										<li>Eliminar visitas</li>
										<li>Listar actividades disponibles</li>
										<li>Inscribirse a una actividades</li>
										<li>Listar las actividades a las que se ha suscrito</li>
