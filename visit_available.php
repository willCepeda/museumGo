						...
						<div class="col-12">
							...
							<!-- Museos -->
								<section class="box">
									...
									<h4>Lista de visitas disponibles</h4>
						
								<?php
								
								$query ="select m.nombre, m.imagen,m.fecha_origen, v.id_visita,v.nombre_visita,v.codigo_pintor,v.codigo_obra from visitas_profesor v, museos m where m.codigo = v.codigo_museo and v.publicado='1'";
								...
								if($count != 0){
												...
												while($row = $rs->fetch_assoc()){
													...
													echo "<header><p><b>Nombre: </b>".$row['nombre_visita']."</p></header>";
													echo "<header><p><b>Obras a visitar:</b> ".$row['codigo_obra']."</p></header>";
													
													
													echo "<span class='image right'><a href='view_visit_student.php?id=".$row['id_visita']."' class='button special' >Ver visita</a></span>";
													
													
													echo "<header><h4><p><b>Pintores relacionados: </b>".$row['codigo_pintor']."</p></h4></header>";
