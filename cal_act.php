			...
			<!-- Main -->
				<section id="main" class="container">
					<header>
						...
						<p>Lista de Actividad Publicadas.</p>
					</header>
					<div class="row">
						<div class="col-12">
									...
									<div >
										<table >
											...
											<?php
												...
												$button_disable="";
												$activate_all="";
												$query = "select h.id,a.nom_acti, a.pregunta,a.tipo,h.id_actividad from hacer_actividad h, actividad_profesor a where h.id_actividad = a.id_actividad and h.id_profesor = '".$_SESSION['id']."' and h.nota!='-1'";
												...
												while($row = $result->fetch_assoc()){
													...
													echo "<td><b>".$row["pregunta"]."</b></td>";
													echo "<td><b>".$row["tipo"]."</b></td>";
													
													echo "<td align='center'>";
													echo "<a href='view_act_cal.php?id=".$row["id_actividad"]."&h=".$row["id"]."' >";
													...
													echo"<tfoot>
												<tr>
													<td colspan='3'>No hay actividad pendiente de calificación</td>
