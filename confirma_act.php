						...
						<div class="col-12">
							...
							<!-- Text -->
								...
								<?php
									...
									$query = "Insert into hacer_actividad (id,id_actividad,id_estudiantes,id_profesor,realizado,respuesta_estudiante,nota ) values (null,'".$_GET['id']."','".$_SESSION['id']."','".$_GET['id_profe']."','0','','-1')";
									//echo $query;
									...
									echo"<header>
										...
										<p>Se ha registrado <b>esta actividad en tu lista de actividades</b></p>
										</header>";
