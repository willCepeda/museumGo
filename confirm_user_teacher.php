...
if(!empty($_POST)){
	if($_POST['boton']=="Actualizar Datos"){
		...
		if(!empty($_POST['new_password'])){
			...
			$sql.=" nombre = '".$_POST['first_name']." ".$_POST['second_name']."', apellidos = '".$_POST['first_lastname']." ".$_POST['second_lastname']."' WHERE profesor.id = '".$_POST['id']."';";
		
		
		
		$result = $conexion->query($sql);
		$msg_confirm ="Se han actualizado los datos del profesor correctamente! ";
