						...
						<div class="col-12">
							...
							<!-- Form -->
								<section class="box">
									...
									<?php
									//$publicado=0;
									if(!empty($_POST["nameVisit"])){
										
										
										
									$query="INSERT INTO visitas_profesor (id_visita, nombre_visita, codigo_profe, codigo_museo, codigo_pintor, codigo_obra, comentarios, publicado) VALUES (NULL, '".$_POST["nameVisit"]."', '".$_SESSION['id']."', '".$_POST["museum"]."', '".$_POST["rsPintores"]."', '".$_POST["rsMuseo"]."', '".$_POST["comentario"]."', '".$_POST["publicado"]."');";
